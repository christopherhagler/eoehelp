...
import eoehelp_api.models  # noqa: F401  isort:skip
...
def _configure(connection: Connection) -> None:
    context.configure(
        ...
        # Enum changes are deliberately not autogenerated: they encode clinical
        # and legal vocabulary and need an explicit, reviewed ALTER TYPE.
